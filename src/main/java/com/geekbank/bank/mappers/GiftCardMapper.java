package com.geekbank.bank.mappers;
...
public class GiftCardMapper {
    ...
    /**
     * Método para truncar cadenas a una longitud máxima.
     *
     * @param value     La cadena a truncar.
     * @param maxLength La longitud máxima permitida.
     * @return La cadena truncada si excede la longitud, de lo contrario, la cadena original.
     */
